...
function Login({ setView }) {
  ...
  const getApiBaseUrl = () => {
    ...
    // Si Vercel tiene una URL configurada, usarla primero.
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (role === 'admin') {
        ...
        // El panel del mecánico es una ruta del backend FastAPI.

        // En producción debe abrirse en Render, no en Vercel.
