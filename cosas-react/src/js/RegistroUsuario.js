            ...
            <form onSubmit={handleSubmit}>
              <div className="row">                       {/* row */}
                <div className="col-12 input-group">
                  ...
                  <input type="text" name="nombre" className="input-field"
              ...
              <div className="row">                       {/* row */}
                <div className="col-12 input-group">
                  ...
                  <input type="email" name="email" className="input-field"
                    value={formData.email} onChange={handleChange} placeholder="correo@empresa.com" />
                </div>
              </div>
              ...
              <div className="row">                       {/* row */}
                <div className="col-12 input-group">
                  ...
                  <input type="password" name="password" className="input-field"
                    value={formData.password} onChange={handleChange} placeholder="Mínimo 6 caracteres" />
                </div>
              </div>
